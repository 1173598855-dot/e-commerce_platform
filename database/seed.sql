...
INSERT INTO users (id, phone, password, nickname, points, login_type, status) VALUES
(1, '13800138000', '$2a$10$yHMhx1pw8v0eJ1m./HT4De/1uKOY68ggKX2AYa6fa60TKjZczD3pC', 'Test User', 100, 'password', 1)
ON DUPLICATE KEY UPDATE password = VALUES(password), nickname = VALUES(nickname), points = VALUES(points), status = VALUES(status);
